/*
  ...
  Changes how fast an LED connected to pin 9 blinks, based on a potentiometer connected to pin A0
...
void setup()
{
    ...
    pinMode(9, OUTPUT); // set pin 9 as an output that can be set to HIGH or LOW
}
